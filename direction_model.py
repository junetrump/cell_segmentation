...
class Network:
    def __init__(self, params, wd=1e-5, modelWeightPaths=None):
        self._params = params
    ...
    def build(self, inputData, ss=None, ssMask=None, keepProb=1.0):
        ...
        print("Shape of inputData:", inputData.get_shape())

        # 打印tf.expand_dims(ssMask,-1)的形
        print("Shape of expanded ssMask:", tf.expand_dims(ssMask,-1).get_shape())
        ...
        # inputData = tf.concat([inputData, tf.expand_dims(ssMask, -1)], axis=3)
        ...
        self.conv3_4 = self._conv_layer(self.conv3_3, params=self._params["direction/conv3_4"])#....

        self.pool3 = self._average_pool(self.conv3_4, 'direction/pool3')#.....
        ...
        self.conv4_4 = self._conv_layer(self.conv4_3, params=self._params["direction/conv4_4"])

        self.pool4 = self._average_pool(self.conv4_4, 'direction/pool4')
        ...
        self.conv5_4 = self._conv_layer(self.conv5_3, params=self._params["direction/conv5_4"])#....


        print("built all CNN layers!")

        self.fcn5_1 = self._conv_layer(self.conv5_4, params=self._params["direction/fcn5_1"])#...
        ...
        self.fcn4_1 = self._conv_layer(self.conv4_4, params=self._params["direction/fcn4_1"])
        ...
        self.fcn3_1 = self._conv_layer(self.conv3_4, params=self._params["direction/fcn3_1"])
